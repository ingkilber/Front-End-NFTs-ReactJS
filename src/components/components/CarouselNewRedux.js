                ...
                <div className="nft__item">
                    ...
                    <div className="author_list_pp">
                        <span onClick={()=> window.open(nft.authorLink, "_self")}>                                    
                            <img src={nft.preview} className="lazy nft__item_preview" alt=""/>
                            <i className="fa fa-check"></i>
                        </span>
                    </div>
                    <div className="nft__item_wrap_new" style={{height: `${height}px`}}>
                      
                        <span>
                            <img src={nft.preview} className="nft__item_wrap" onLoad={onImgLoad} alt=""/>
                        </span>
